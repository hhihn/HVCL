...
if args.approach == 'fine-tuning':
    ...
    log_name = '{}_{}_{}_{}_lamb_{}_mu_{}'.format(args.date, args.experiment, args.approach, args.seed, args.ucl_rho,
                                                  args.ucl_beta)
...
taskcla = [(0, 6), (1, 6), (2, 8), (3, 1), (4, 3)]
task_sequences = [(0, 'Walker2DPyBulletEnv-v0'), (1, 'HalfCheetahPyBulletEnv-v0'), (2, 'AntPyBulletEnv-v0'),
                  (3, 'InvertedDoublePendulumPyBulletEnv-v0'), (4, 'HopperPyBulletEnv-v0')]
...
for task_idx, env_name in task_sequences:
    ...
    print("rollouts", len(rollouts.obs))
    # if args.experiment == 'roboschool':
    ...
    train_ppo(actor_critic, agent, rollouts, task_idx, env_name, task_sequences, envs, new_obs, obs_shape,
              obs_shape_real, args,
